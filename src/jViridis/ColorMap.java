 ...
 * 
 * It works with 'viridis', 'inferno', 'magma', and 'plasma' color maps
...
public class ColorMap {
	...
	/**
	 * Retrieves a color from the current colorMap corresponding to a value
	 * mapped within a range. It matches the min and max range values to the
	 * extreme values of the colorMap and picks the color corresponding to the
	 * linear mapping of the desired value on the colorMap
	 * 
	 * @param min
