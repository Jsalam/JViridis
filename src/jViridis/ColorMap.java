...
public class ColorMap {
	 ...
	 * returned gradient ranges from full brightness to 80% brightness.
	 * 
	 * @param c the java.lang.Color 
	 * @param steps the number of gradient steps
	 ...
	 * @param c the java.lang.Color
	 * @param totalSteps the number of gradient steps
	 * @param position the color position in the gradient scale
